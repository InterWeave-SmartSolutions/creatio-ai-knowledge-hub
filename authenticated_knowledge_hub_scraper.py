...
if __name__ == "__main__":
    try:
        parser = base_parser("Authenticated Knowledge Hub scraper")
    except Exception:
        parser = argparse.ArgumentParser(description="Authenticated Knowledge Hub scraper")
    ...
    print(json.dumps({
        "tool": "authenticated_knowledge_hub_scraper",
