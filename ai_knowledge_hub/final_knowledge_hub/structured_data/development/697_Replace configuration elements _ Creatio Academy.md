...
**Category:** development **Difficulty:** beginner **Word Count:** 323 **URL:**
https://academy.creatio.com/docs/8.x/dev/development-on-creatio-platform/development-tools/creatio-ide/replace-configuration-elements
...
on the system level. Develop and modify the functionality in custom
[packages](https://academy.creatio.com/documents?ver=8.3&id=15121) using the
...
client module, use the replacing view model schema. Instructions:
[Client module](https://academy.creatio.com/documents?ver=8.3&id=15106&anchor=title-3028-4).

- **Object**.

Objects implement the back-end of Creatio. To create a replacing object, use the
replacing object schema. Instructions:
[Object](https://academy.creatio.com/documents?ver=8.3&id=15107&anchor=title-3028-7).
...
**Source code** type. Instructions:
[Source code (C#)](https://academy.creatio.com/documents?ver=8.3&id=15108&anchor=title-3028-16).
