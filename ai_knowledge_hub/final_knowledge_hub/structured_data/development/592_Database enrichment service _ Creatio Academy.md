...
https://academy.creatio.com/docs/8.x/dev/development-on-creatio-platform/8.0/architecture/microservices/database-enrichment
...
1. The
   [Synch Engine mechanism](https://academy.creatio.com/documents?ver=8.0&id=15781)
...
- **Creatio cloud services API key** – by default, this setting is populated for
  ...
  [Data enrichment service](https://academy.creatio.com/documents?ver=8.0&id=1642)
  article.
...
[Contact data enrichment from emails](https://academy.creatio.com/documents?ver=8.0&id=15778)
